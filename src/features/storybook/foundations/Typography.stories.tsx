...
const typeSamples = [
  ...
  ['body.lg', '16 / 24 · 400', 'Один экран должен объяснять одну мысль и вести к понятному действию.', 'text-base leading-6'],
  ['body.md', '15 / 22 · 400', 'Стандартный текст интерфейса для карточек и подсказок.', 'text-[15px] leading-[22px]'],
  ['body.sm', '14 / 20 · 400', 'Второстепенная подпись без потери читаемости.', 'text-sm leading-5'],
  ['caption.md', '13 / 18 · 400', 'Метаданные и спокойные уточнения.', 'text-[13px] leading-[18px]'],
  ['caption.sm', '11 / 14 · 600', 'КОМПАКТНАЯ МЕТКА', 'text-[11px] font-semibold leading-[14px]'],
